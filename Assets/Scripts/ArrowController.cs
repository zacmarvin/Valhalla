...
public class ArrowController : MonoBehaviour
{
    ...
    {
        if (gameObject.CompareTag("Friendly Arrow") && collision.gameObject.CompareTag("Enemy") || gameObject.CompareTag("Enemy Arrow") && collision.gameObject.CompareTag("Friendly"))
        {
            timesPenetrated += 1;
